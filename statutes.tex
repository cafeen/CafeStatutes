...
\stk Valget gennemføres herefter således:
    ...
    Dernæst stemmes om resten af de opstillede - inklusive personer fravlagt i første runde - og der kan sættes op til så mange krydser, som der er personer på valg, men der kan dog kun sættes færre krydser end antallet af personer, der blev valgt i første runde. De personer, der har flest stemmer vælges til bestyrelsen - dog skal der stemmes for af mindst halvdelen af de stemmeberettigede.
...
\stk Hvis der er flere indbyrdes modstridende forslag til beslutning, stemmes for hvert af forslagene.
